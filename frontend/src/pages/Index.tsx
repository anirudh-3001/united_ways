...
import { Truck, BarChart3, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
        ...
        <div className="w-full max-w-sm space-y-4">
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h2 className="text-lg font-bold text-foreground mb-1">{t.dashboardTitle}</h2>
                <p className="text-muted-foreground text-sm mb-2">{t.dashboardSubtitle}</p>
                <p className="text-xs text-muted-foreground">{t.viewAnalytics}</p>
              </div>
        ...
        <div className="mt-10 text-center">
          <div className="flex items-center justify-center gap-8">
            <div>
              ...
              <p className="text-sm text-muted-foreground">{t.driversLabel}</p>
            </div>
            <div className="w-px h-10 bg-border" />
            <div>
              <p className="text-3xl font-bold text-foreground">5</p>
              <p className="text-sm text-muted-foreground">{t.zonesLabel}</p>
            </div>
            <div className="w-px h-10 bg-border" />
            <div>
              <p className="text-3xl font-bold text-primary">₹8L+</p>
      ...
      <footer className="p-6 text-center">
        <p className="text-xs text-muted-foreground">{t.footerText || t.oneTimeLogin}</p>
      </footer>
    </div>
  );
}
